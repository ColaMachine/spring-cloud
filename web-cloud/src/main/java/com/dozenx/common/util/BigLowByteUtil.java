...
*/
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(com.dozenx.common.util.ByteUtil.toBinaryStr(5419));
        System.out.println(com.dozenx.common.util.ByteUtil.toBinaryStr(102));
        System.out.println(com.dozenx.common.util.ByteUtil.toBinaryStr(43));
        System.out.println(com.dozenx.common.util.ByteUtil.toBinaryStr(com.dozenx.common.util.ByteUtil.HEX_1_1_0_0));
